  ...
  return (
    <footer className="bg-slate-50 text-slate-900 border-t border-slate-200">
      <div className="container mx-auto px-4 py-12 lg:py-16">
        ...
        <div className="mt-10 pt-6 lg:mt-12 lg:pt-8 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 lg:gap-6">
            {legal.map((link) => (
              <Link 
                key={link.href}
                href={link.href}
                className="text-sm text-slate-500 hover:text-purple-600 transition-colors whitespace-nowrap"
              >
                {link.label}
              </Link>
            ))}
