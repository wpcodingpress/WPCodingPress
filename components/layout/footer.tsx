        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-indigo-500 transition-colors">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-indigo-500 transition-colors">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center hover:bg-indigo-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:contact@wpcodingpress.com" className="text-sm text-slate-400 hover:text-indigo-400 transition-colors">
                  contact@wpcodingpress.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="h-4 w-4 text-indigo-400 mt-0.5" />
                <a href="tel:+8801943429727" className="text-sm text-slate-400 hover:text-indigo-400 transition-colors">
                  +880 1943 429727
                </a>
              </li>
            </ul>
