...
import { ArrowLeft, Calendar, Clock, Share2, Link as LinkIcon, Mail } from "lucide-react"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    onClick={() => {
                      ...
                      navigator.clipboard.writeText(`https://www.facebook.com/sharer/sharer.php?u=${url}`)
                    }}
                    className="p-2 rounded-lg bg-white/10 text-slate-300 hover:text-white hover:bg-white/20 transition-colors"
                  ...
                  <button 
                    onClick={() => {
                      ...
                      navigator.clipboard.writeText(`https://twitter.com/intent/tweet?url=${url}&text=${text}`)
                    }}
                    className="p-2 rounded-lg bg-white/10 text-slate-300 hover:text-white hover:bg-white/20 transition-colors"
                  ...
                  <button 
                    onClick={() => {
                      const url = encodeURIComponent(window.location.href)
                      navigator.clipboard.writeText(`https://www.linkedin.com/shareArticle?mini=true&url=${url}`)
                    }}
                    className="p-2 rounded-lg bg-white/10 text-slate-300 hover:text-white hover:bg-white/20 transition-colors"
