...
export const metadata: Metadata = {
  ...
  description: 'Intelligent AI agents for automation, customer service, and business workflows.',
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">AI Agents</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Intelligent agents that work 24/7 for your business.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-3xl p-16">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">AI Agent Suite Under Construction</h2>
            <p className="text-slate-400 text-lg mb-8">Customer support, lead generation, content creation, and more.</p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="px-4 py-2 bg-orange-500/20 text-orange-300 rounded-full">Support</span>
              <span className="px-4 py-2 bg-blue-500/20 text-blue-300 rounded-full">Leads</span>
              <span className="px-4 py-2 bg-green-500/20 text-green-300 rounded-full">Content</span>
            </div>
          </div>
        </div>
      </section>
