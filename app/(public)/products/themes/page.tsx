...
export const metadata: Metadata = {
  ...
  description: 'Premium WordPress themes for every industry. Beautiful, responsive themes built for speed and conversion.',
  keywords: 'wordpress themes, premium wordpress themes, responsive wordpress themes, wordpress theme templates',
};
...
export default async function ThemesPage() {
  const products = await getProductsByType('theme');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Premium WordPress Themes</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Beautiful, performance-optimized themes for every type of website. 
            From blogs to e-commerce, we've got you covered.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-3xl p-12">
              <div className="w-20 h-20 rounded-full bg-green-500/20 flex items-center justify-center mx-auto mb-6">
                <Palette className="w-10 h-10 text-green-400" />
              </div>
              <h2 className="text-3xl font-bold text-white mb-4">No Themes Available Yet</h2>
              <p className="text-slate-400 text-lg mb-8">We're designing beautiful themes for you. Check back soon!</p>
              <Link 
                href="/products" 
                className="inline-flex items-center gap-2 px-6 py-3 bg-green-500/20 text-green-400 rounded-xl hover:bg-green-500/30 transition-colors"
              >
                Browse All Products
              ...
              {products.map((product) => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-slate-800/50 border border-slate-700/50 rounded-2xl overflow-hidden hover:border-green-500/50 hover:bg-slate-800/70 transition-all"
                  >
      ...
      <section className="py-16 px-4 bg-slate-900/30">
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-white mb-6">Theme Features</h2>
