...
export const metadata: Metadata = {
  ...
  description: 'Production-ready Next.js templates for SaaS, portfolios, e-commerce, and more.',
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <section className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Next.js Templates</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Beautiful, production-ready templates to launch your project faster.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-3xl p-16">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Template Collection Launching Soon</h2>
            <p className="text-slate-400 text-lg mb-8">SaaS, portfolios, e-commerce, and more.</p>
